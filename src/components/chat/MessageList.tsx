  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-foreground font-semibold text-lg mb-2">Mulai percakapan untuk membuat komponen React</p>
        <p className="text-muted-foreground text-sm max-w-sm">Saya bisa membantu membuat tombol, formulir, kartu, dan lainnya</p>
      </div>
    );
  }
                          ...
                          case "reasoning":
                            return (
                              <div key={partIndex} className="mt-3 p-3 bg-background/50 rounded-md border border-border">
                                <span className="text-xs font-medium text-muted-foreground block mb-1">Penalaran</span>
